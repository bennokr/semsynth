...
- `semsynth/` holds the reporting pipeline, backends, metadata utilities, CLI entrypoints, and packaged runtime assets (`semsynth/templates`, `semsynth/mapping_data`).
